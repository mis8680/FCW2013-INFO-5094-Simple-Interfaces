...
*/
    public function testSort()
    {
        ...
        $singleLinkedList->add('nodeTest53');
        $singleLinkedList->add('nodeTest51');
        $singleLinkedList->add('nodeTest52');
        
        
        $singleLinkedList->sort();
        //print_r($singleLinkedList->asArray());
        $this->assertEquals('nodeTest51', $singleLinkedList->getFirst());
    }
...
*/
    public function testSortBy()
    {
        ...
        $singleLinkedList->sortBy(array($singleLinkedList, 'myCallback'));
        //print_r($singleLinkedList->asArray());
        $this->assertEquals('nodeTest51', $singleLinkedList->getFirst());
    }
